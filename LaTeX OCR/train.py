...
dataset = vision.ImageDataset(dataset_name, image_processor, name = 'human_handwrite_print')
...
multimodal_model = anymodal.MultiModalModel(
    ...
    prompt_text="The latex expression of the handwritten equation in the image is: ")
